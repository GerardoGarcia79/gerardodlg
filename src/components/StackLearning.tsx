    ...
    <div className='flex flex-col border-2 border-white/10 rounded-lg p-5 transition ease-out hover:scale-105 hover:border-[#00a8e8]/50 duration-300'>
            ...
            <div className='grid grid-cols-3 mb-3'>
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <p className='text-white text-sm mt-1'>Next.js</p>
                </div>
                <div className='flex flex-col items-center justify-center'>
                    <img src={reactQuery} alt="React Query logo" className='w-12 h-12 rounded-sm' />
                    <p className='text-white text-sm mt-1'>React Query</p>
                </div>
                <div className='flex flex-col items-center justify-center'>
                    <img src={zustand} alt="Zustand logo" className='w-12 h-12 rounded-sm' />
                    <p className='text-white text-sm mt-1'>Zustand</p>
                </div>
            </div>
            {/* row */}
            <div className='grid grid-cols-3 mb-3'>
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <p className='text-white text-sm mt-1'>Chakra UI</p>
                </div>
            </div>
        </div>
  )
