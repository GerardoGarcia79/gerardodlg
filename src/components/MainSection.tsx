        ...
        <div className="flex items-center mt-4 relative">
          ...
          >
            ...
            <div ref={dropDownListRef} className={`absolute top-[110%] left-[96px] w-[130.94px] ${showResumeLinks ? 'h-fit visible opacity-100 transition-all ease-in-out duration-300' : 'invisible opacity-0 transition-all ease-in-out duration-300'}`}>
                <ul className="bg-[#616161] rounded-lg border-2 border-white/20">
                <li onClick={() => setShowResumeLinks(false)} className="hover:bg-[#0081b4] transition ease-out duration-300 mb-[1px]">
                  <a href="../CV-EN.pdf" download className={`flex items-center justify-center text-white h-10 px-1 text-lg `}>
                <MdOutlineFileDownload size='20px' className="mr-[2px]"/>CV-EN
                </a>
                  </li>
                  <li onClick={() => setShowResumeLinks(false)} className="hover:bg-[#0081b4] transition ease-out duration-300">
                  <a href="../CV-EN.pdf" download className={`flex items-center justify-center text-white h-10 px-1 text-lg `}>
