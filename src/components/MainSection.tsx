    ...
    <div id="header" className="grid grid-cols-1 gap-y-5 my-6 py-[25px] lg:grid-cols-3 md:gap-y-0 md:py-[100px] lg:py-[250px]">
      <div className="md:col-span-2">
        ...
        <div className="flex items-center mt-4 [&_*]:mr-2">
          ...
          <a href="../CV-EN.pdf" download className="flex items-center justify-center text-white h-10 bg-[#00a8e8] rounded-lg px-4 text-lg hover:bg-[#0081b4] transition ease-out hover:-translate-y-1 hover:scale-110 duration-300">
            My resume
          </a>
        </div>
      </div>
